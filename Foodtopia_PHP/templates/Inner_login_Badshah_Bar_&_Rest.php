...
if(isset($_POST['submit'])){
    ...
    $sql = "select * from inner_login_badshah_bar_n_rest where Name = '$shop_username' and Email = '$shop_email' and Shop_Name = '$shop_name' 
    and Shop_ID = '$shop_id' and Pvt_user_ID = '$pvt_user_id'";

    $result=mysqli_query($conn, $sql);

    if(mysqli_num_rows($result)==1){
        header('Location: Badshah_Bar_&_Rest_inside.php');
       echo "Correct";
    }
    else{
...
<html lang="en">
<head>
<title>Inner Login-Badshah Bar & Restaurant</title>
...
<img class ="center user_symbol_img" src="static\Images\User Symbol.jpg" height="81px" weight="81px">
         <h1 class="form-header center">Shop Login(Badshah Bar & Restaurant)</h1>
             <form action="Inner_login_Badshah_Bar_&_Rest.php" method="POST">
