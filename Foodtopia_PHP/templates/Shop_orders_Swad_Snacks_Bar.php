...
$sql = "select * from swad_snacks_bar_orders ";
...
<header class="header-background">
    ...
    <nav class="red">
        ...
        <a class="link-nav link-nav-hover" href="Swad_Snacks_Bar_orders.php">Orders</a>
...
<section class="container white">
     ...
     <p>Egg Roll: <?php echo htmlspecialchars($order_data['Egg_roll']);?> </p>
     <p>Chicken Momo: <?php echo htmlspecialchars($order_data['Chicken_momo']);?> </p>
     <p>Chicken Chowmein: <?php echo htmlspecialchars($order_data['Chicken_chowmein']);?> </p>
     <p>Chicken Fried Rice: <?php echo htmlspecialchars($order_data['Chicken_fried_rice']);?> </p>
     <p>Paneer Roll: <?php echo htmlspecialchars($order_data['Paneer_roll']);?> </p>
     <p>Veg Momo: <?php echo htmlspecialchars($order_data['Veg_momo']);?> </p>
     <p>Veg Chowmein: <?php echo htmlspecialchars($order_data['Veg_chowmein']);?> </p>
