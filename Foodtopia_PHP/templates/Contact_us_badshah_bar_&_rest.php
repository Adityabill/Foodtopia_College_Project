...
if(isset($_POST['submit'])){
      ...
      $sql ="insert into contact_us_shop(Name, Email, Shop_Name, Shop_ID, Subject, Description)
             ...
             if(mysqli_query($conn, $sql)){
                header('Location: Contact_us_badshah_bar_&_rest_submit_success.php');
            } 
            else{
...
<header class="header-background">
        <a href="Badshah_Bar_&_Rest_inside.php"><img class="foodtopia-logo" src="static/Images/Foodtopia Logo.jpg" width="150px" height="150px" ></a>
    ...
    <h3 class="center">Query</h3>
        <form class="" action="Contact_us_badshah_bar_&_rest.php" method="POST">
        <label>Subject 
