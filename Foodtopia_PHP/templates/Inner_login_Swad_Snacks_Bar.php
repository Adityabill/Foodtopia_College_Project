...
if(isset($_POST['submit'])){
    ...
    $sql = "select * from inner_login_swad_snacks_bar where Name = '$shop_username' and Email = '$shop_email' and Shop_Name = '$shop_name' 
    and Shop_ID = '$shop_id' and Pvt_user_ID = '$pvt_user_id'";

    $result=mysqli_query($conn, $sql);

    if(mysqli_num_rows($result)==1){
        header('Location: Swad_Snacks_Bar_inside.php');
       echo "Correct";
    }
    else{
...
<html lang="en">
<head>
<title>Inner Login-Swad Snacks Bar</title>
...
<img class ="center user_symbol_img" src="static\Images\User Symbol.jpg" height="81px" weight="81px">
         <h1 class="form-header center">Shop Login(Swad Snacks Bar)</h1>
             <form action="Inner_login_Swad_Snacks_Bar.php" method="POST">
