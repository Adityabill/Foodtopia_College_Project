...
if(isset($_POST['submit'])){
      ...
      $sql ="insert into feedback_n_griviences(Name, Email, Phone_no, Subject, Description)
             values('$username', '$user_email', '$user_phone_no', '$subject', '$desc') ";
...
<html lang="en">
<head>
    <title>Feedback and Griviences</title>
...
<body class="background-img" onload=display_ct() background="static/Images/ccu_chicken_biriyani.jfif">
    ...
    <h3 class="center">Query</h3>
        <form class="" action="Feedback_&_Griviences_user.php" method="POST">
        <label>Subject 
