    ...
    <section class="container">
        <div class="white rest-box-border">
              <h3 class="restaurant_section_font">
                Swad Snacks Bar</h3> 
              <a href="User_orders_page_swad_snacks_bar.php" class="btn rest_view_btn">View</a>  
        </div>

        <div class="white rest-box-border">
            <h3 class="restaurant_section_font">Arsalan Biriyani</h3>
            <a href="User_orders_page_arsalan_biriyani.php" class="btn rest_view_btn">View</a>  
      </div>

      <div class="white rest-box-border">
        <h3 class="restaurant_section_font">Badshah Bar and Restaurant</h3>
        <a href="User_orders_page_badshah_bar_&_rest.php" class="btn rest_view_btn">View</a>  
    </div>
